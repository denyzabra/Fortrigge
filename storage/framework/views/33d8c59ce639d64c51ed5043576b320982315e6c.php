    ...
    <div class="codex-menuwrapper">
        <ul class="codex-menu custom-scroll" data-simplebar>
            ...
            <?php if(Gate::check('manage property') || Gate::check('manage unit')|| Gate::check('manage tenant') || Gate::check('manage invoice') || Gate::check('manage expense') || Gate::check('manage maintainer') || Gate::check('manage maintenance request') || Gate::check('manage contact') || Gate::check('manage support') || Gate::check('manage note')): ?>
                <li class="cdxmenu-title">
                    <h5><?php echo e(__('Property Management')); ?></h5>
                </li>
                    ...
                    <li class="menu-item <?php echo e(in_array($routeName,['property.index','property.create','property.edit','property.show','unit.index'])?'active':''); ?>">
                        ...
                        <ul class="submenu-list"
                            ...
                            <?php if(Gate::check('manage property')): ?>
                                <li class="menu-item <?php echo e(in_array($routeName,['property.index','property.create','property.edit','property.show'])?'active':''); ?> ">
                                    <a href="<?php echo e(route('property.index')); ?>">  <?php echo e(__('Properties')); ?> </a>
                                </li>
                            <?php endif; ?>
                            <?php if(Gate::check('manage unit')): ?>
                                <li class="menu-item <?php echo e(in_array($routeName,['unit.index'])?'active':''); ?> ">
                    ...
                    <li class="menu-item <?php echo e(in_array($routeName,['maintenance-request.index','maintenance-request.pending','maintenance-request.inprogress'])?'active':''); ?>">
                        ...
                        <ul class="submenu-list"
                            ...
                            <?php if(Gate::check('manage maintenance request')): ?>
                                <li class="menu-item <?php echo e(in_array($routeName,['maintenance-request.index'])?'active':''); ?>">
                                    <a href="<?php echo e(route('maintenance-request.index')); ?>"><?php echo e(__('All Requests')); ?> </a>
                                </li>
                            <?php endif; ?>
                            <?php if(Gate::check('manage maintenance request')): ?>
                                <li class="menu-item <?php echo e(in_array($routeName,['maintenance-request.pending'])?'active':''); ?>">
                                    <a href="<?php echo e(route('maintenance-request.pending')); ?>"><?php echo e(__('Pending')); ?> </a>
                                </li>
                            <?php endif; ?>
                            <?php if(Gate::check('manage maintenance request')): ?>
                                <li class="menu-item <?php echo e(in_array($routeName,['maintenance-request.inprogress'])?'active':''); ?>">
                    ...
                    <li class="menu-item <?php echo e(in_array($routeName,['invoice.index','invoice.create','invoice.edit','invoice.show','expense.index'])?'active':''); ?>">
                        ...
                        <ul class="submenu-list"
                            ...
                            <?php if(Gate::check('manage invoice')): ?>
                                <li class="menu-item <?php echo e(in_array($routeName,['invoice.index','invoice.create','invoice.edit','invoice.show'])?'active':''); ?>">
            ...
            <?php if(Gate::check('manage types')): ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <?php if(Gate::check('manage pricing packages') || Gate::check('manage pricing transation') || Gate::check('manage account settings') || Gate::check('manage password settings') || Gate::check('manage general settings') || Gate::check('manage company settings') || Gate::check('manage payment settings')): ?>
                <li class="cdxmenu-title">
                    <h5><?php echo e(__('System Settings')); ?></h5>
                </li>

                <?php if(Gate::check('manage account settings') || Gate::check('manage password settings') || Gate::check('manage general settings') || Gate::check('manage company settings') || Gate::check('manage seo settings') || Gate::check('manage google recaptcha settings') || Gate::check('manage payment settings')): ?>
...
<!-- sidebar end-->
<?php /**PATH C:\xampp\htdocs\Fortrigge\resources\views/admin/menu.blade.php ENDPATH**/ ?>