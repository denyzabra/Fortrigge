                ...
                <div class="card-body">
                    <div class="info-group">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                <?php echo e(Form::label('state',__('Region'),array('class'=>'form-label'))); ?>

                                <?php echo e(Form::text('state',null,array('class'=>'form-control','placeholder'=>__('Enter Region')))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Fortrigge\resources\views/tenant/create.blade.php ENDPATH**/ ?>